...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Listening for userPhone input until proper input is received. Definitely want to figure
        // out how to do this properly without repeating code twice
    ...
    // TODO: 7/19/2021 Add validation for non-number characters, like '-' and '+'
    // Input validation for phone entry
    private fun validPhone(userPhone: String?): Boolean = if (userPhone?.length != 10) {
        Toast.makeText(
